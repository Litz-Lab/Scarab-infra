...
# cd /home/memtrace/traces && /home/memtrace/dynamorio/build/bin64/drrun -t drcachesim -offline -trace_after_instrs 100000000 -exit_after_tracing 101000000 -outdir ./ -- $SOLR_HOME/bin/solr start -force -cloud -f -p $SOLR_PORT -s $SOLR_CORE_DIR -m $SERVER_HEAP_SIZE

# sed -i 's/exec/cd \/home\/memtrace\/traces \&\& \/home\/memtrace\/dynamorio\/build\/bin64\/drrun -disable_traces -no_hw_cache_consistency -no_sandbox_writes -no_enable_reset -sandbox2ro_threshold 0 -ro2sandbox_threshold 0 -t drcachesim -offline -trace_after_instrs 100M -exit_after_tracing 101M -outdir .\/ -- /' $SOLR_HOME/bin/solr
...
cp -r $SOLR_HOME/server/. /home/memtrace/traces
cp -r $SOLR_HOME/server/. /home/memtrace/exp
