...
case $APPNAME in
  cassandra | kafka | tomcat)
    BINCMD="java -jar $tmpdir/dacapo-evaluation-git+309e1fa-java8.jar $APPNAME -n 10"
    ;;
  chirper | http)
