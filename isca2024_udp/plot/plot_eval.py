  ...
  try:
    for config_key in descriptor_data["configurations"].keys():
      ...
      if config_key == "baseline/IncreasedIcache40K":
        ...
        config_name = "FDIP + EIP (8K)"
      elif config_key == "udp_8k/btb8k/pessimistic_bitmap":
        config_name = "UDP"
      elif config_key == "udp/btb8k/pessimistic_bitmap":
        config_name = "Infinite Storage"
      elif config_key == "baseline/32":
        config_name = "Baseline (FTQ=32)"
      elif config_key == "baseline/DJOLT":
        config_name = "FDIP + D-JOLT (8K)"
      elif config_key == "udp_8k/EIP":
        config_name = "UDP + EIP"
      elif config_key == "udp_8k/DJOLT":
        config_name = "UDP + D-JOLT"
    ...
    plot_data(benchmarks, imiss_cycle, '# of Insts lost due to misses Per KI')
